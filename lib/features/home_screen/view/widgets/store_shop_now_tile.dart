...
class StoreShopNowTile2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (boomModel != null) {
      ...
      if (boomModel.promotionCashbackOfferStatus == 'active' &&
          boomModel.promotionCashbackOfferDate.startDate.isBefore(today) &&
          boomModel.promotionCashbackOfferDate.endDate.isAfter(today)) {
